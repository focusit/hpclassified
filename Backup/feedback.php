...
function isPosInteger(inputVal)
{
 ...
 function func()
 {
  ...
  if(strlen(val) <= 6 || strlen(val) >= 11 ||  !isPosInteger(val))
  {
   ...
   val=document.getElementById("txfeedback").value;
  if(strlen(val) <= 0 )
  {
    alert('Give Your Feed Back !');
	flag=0;
	return false;
   }
  ...
  <tr>
    <td colspan="4" align="left" valign="bottom"><table width="100%" height="187" border="0" cellpadding="3" cellspacing="3">
	  ...
	  <td width="33%" align="right"><img src="images/himachal-classified-for-free-listing.png" alt="classified-for-free-listing" /></td>
        <td width="34%" height="184" align="center" valign="top"><form id="form3" name="form3" method="post" action="feedback.php?feed=1" onSubmit="return func()" ><table width="95%" bgcolor="#2E83CC">
          <tr>
		  ...
		  <tr>
		   ...
		   <tr>
            <td><span class="style1">Your Feed Back</span></td>
            <td><textarea name="txfeedback" id="txfeedback" rows="2" cols="27"></textarea></td>
          </tr>
...
if($_GET['feed']==1)	{
		...
		$email1='himachalclassified@gmail.com';
			...
			$subject = "Feed Back for Himachal Classified";
			$message = '<table border="1" bgcolor="#2E83CC" width="100%"><tr><td><font color="#FFFFFF">Name</font></td><td><font color="#FFFFFF">'.$name.'</font></td></tr>
								...
								<tr><td><font color="#FFFFFF">Feed Back</font></td><td><font color="#FFFFFF">'.$feed.'</font></td></tr>
			...
			<p>Your Feed Back has been sent to administer</p>'; 
